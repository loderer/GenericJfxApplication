...
public class GenericJfxApplication extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        GenericJfxApplication.primaryStage = primaryStage;
        ...
        GenericJfxApplication.primaryStageObservable = new Observable();

        GenericJfxApplication.scene2Observable = new HashMap<>();

        primaryStage.setTitle(GenericJfxApplication.primaryStageTitle);

        setOnCloseRequest(GenericJfxApplication.primaryStageObservable, primaryStage);
    ...
    public StageHandle createStage(final String title,
        ...
        synchronized (initializationCompletedMonitor) {
            initializationCompleted = GenericJfxApplication.initializationCompleted;
        }
